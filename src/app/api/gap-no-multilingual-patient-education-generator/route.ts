...
// Batch 10 Gap: "No multilingual patient-education generator" (ai-gap) for healthcare_salesforce
// Mount path: /api/gap-no-multilingual-patient-education-generator
