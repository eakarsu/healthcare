...
// Batch 10 Gap: "No live telehealth + ambient-scribe integration" (ai-gap) for healthcare_salesforce
// Mount path: /api/gap-no-live-telehealth-ambient-scribe-integration
