...
// Batch 10 page: "DICOM viewer with AI image triage" (cfs) — healthcare_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "dicom-viewer-with-ai-image-triage";
const LABEL = "DICOM viewer with AI image triage";
const SECTION = "cfs";
const API_PATH = "/api/cf-dicom-viewer-with-ai-image-triage";

export default function DicomViewerWithAiImageTriagePage() {
