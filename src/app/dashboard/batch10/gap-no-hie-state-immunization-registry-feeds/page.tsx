...
// Batch 10 page: "No HIE / state immunization registry feeds" (nonai-gap) — healthcare_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-hie-state-immunization-registry-feeds";
const LABEL = "No HIE / state immunization registry feeds";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-hie-state-immunization-registry-feeds";

export default function NoHieStateImmunizationRegistryFeedsPage() {
