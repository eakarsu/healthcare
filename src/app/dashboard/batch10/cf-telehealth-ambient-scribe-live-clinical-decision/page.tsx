...
// Batch 10 page: "Telehealth + ambient scribe + live clinical decision support" (cfs) — healthcare_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "telehealth-ambient-scribe-live-clinical-decision";
const LABEL = "Telehealth + ambient scribe + live clinical decision support";
const SECTION = "cfs";
const API_PATH = "/api/cf-telehealth-ambient-scribe-live-clinical-decision";

export default function TelehealthAmbientScribeLiveClinicalDecisionPage() {
