...
// Batch 10 page: "No bed / OR management" (nonai-gap) — healthcare_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-bed-or-management";
const LABEL = "No bed / OR management";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-bed-or-management";

export default function NoBedOrManagementPage() {
