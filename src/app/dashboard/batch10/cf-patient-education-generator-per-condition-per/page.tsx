...
// Batch 10 page: "Patient education generator (per condition, per literacy level, multilingual)" (cfs) — healthcare_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "patient-education-generator-per-condition-per";
const LABEL = "Patient education generator (per condition, per literacy level, multilingual)";
const SECTION = "cfs";
const API_PATH = "/api/cf-patient-education-generator-per-condition-per";

export default function PatientEducationGeneratorPerConditionPerPage() {
