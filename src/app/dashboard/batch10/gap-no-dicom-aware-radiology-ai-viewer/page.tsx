...
// Batch 10 page: "No DICOM-aware radiology AI viewer" (ai-gap) — healthcare_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-dicom-aware-radiology-ai-viewer";
const LABEL = "No DICOM-aware radiology AI viewer";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-dicom-aware-radiology-ai-viewer";

export default function NoDicomAwareRadiologyAiViewerPage() {
