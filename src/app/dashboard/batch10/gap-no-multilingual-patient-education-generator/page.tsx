...
// Batch 10 page: "No multilingual patient-education generator" (ai-gap) — healthcare_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-multilingual-patient-education-generator";
const LABEL = "No multilingual patient-education generator";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-multilingual-patient-education-generator";

export default function NoMultilingualPatientEducationGeneratorPage() {
