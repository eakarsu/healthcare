...
// Batch 10 page: "No outbound AI-driven no-show outreach (predictor exists, intervention loop missing)" (ai-gap) — healthcare_salesforce
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-outbound-ai-driven-no-show";
const LABEL = "No outbound AI-driven no-show outreach (predictor exists, intervention loop missing)";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-outbound-ai-driven-no-show";

export default function NoOutboundAiDrivenNoShowPage() {
